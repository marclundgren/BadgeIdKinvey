...
*/
var localStorage = require('react-native').AsyncStorage;
...
(function (root, definition) {
    ...
    function Logger(name, defaultLevel, factory) {
      ...
      function persistLevelIfPossible(levelNum) {
          ...
          try {
              localStorage[storageKey] = levelName;
              return;
          } catch (ignore) {}
      ...
      function getPersistedLevel() {
          ...
          try {
              storedLevel = localStorage[storageKey];
          } catch (ignore) {}
...
(function (root, factory) {
    ...
    if (reactNative) {
      root.Queue = factory();
        ...
        // CommonJS
        module.exports = factory(root); // react-native
    } else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define(factory);
    } else {
        // Browser globals
        root.Queue = factory(); // react-native
    }
})
(this, function (root) {
    'use strict';
...
(function() {
  ...
  var kinveyFn = function() {
    ...
    var restoreActiveUser = function(options) {
      ...
      .then(function(user) {
        ...
        if(false === options.refresh) {
          return Kinvey.getActiveUser('kinveyFn');
        }
     ...
     */
    Kinvey.getActiveUser = function(methodName) {
      ...
      if(false === activeUserReady) {
        throw new Kinvey.Error(methodName + ': Kinvey.getActiveUser can only be called after the ' +
    ...
    Kinvey.setActiveUser = function(user) {
      ...
      var result = Kinvey.getActiveUser('setActiveUser'); // Previous.
      activeUser = user;
    ...
    Kinvey.init = function(options) {
      ...
      //   resolve('we got here, also Promise is availale');
      // });
      ...
      var promise = Database.upgrade().then(function() {
        ...
        logger.debug('Kinvey initialized, running version: js-html5/1.5.1');

        // why isn't this here?
        activeUserReady = true;

        console.log('restoreActiveUser', restoreActiveUser(options));
    ...
    Kinvey.ping = function(options) {
      ...
      //   // return 'Pinged the Kinvey service.' + response;
      // }, function(error) {
      //   debugger
      //   console.log('Failed to ping the Kinvey service.', error);
    ...
    var methodNotImplemented = function(methodName) {
      return function() {
        // react-native doesn't swallow thrown errors

        if (typeof console && console.log) {
          console.log('Method not implemented: ' + methodName);
        }
      };
    };
    ...
    var Auth = /** @lends Auth */ {
      ...
      Session: function() {
        ...
        var error;
        // debugger
        var user = Kinvey.getActiveUser('Session');
    ...
    Kinvey.Social = /** @lends Kinvey.Social */ {
      ...
      connect: function(user, provider, options) {
        ...
        var promise = Social[provider](options).then(function(tokens) {
          ...
          var activeUser = Kinvey.getActiveUser('connect');
    ...
    Kinvey.User = /** @lends Kinvey.User */ {
      ...
      login: function(usernameOrData, password, options) {
        ...
        // Validate preconditions.
        if(null !== Kinvey.getActiveUser('login')) {
      ...
      logout: function(options) {
        ...
        var promise;
        if(null === Kinvey.getActiveUser('logout')) {
      ...
      me: function(options) {
        ...
        var promise = Kinvey.Persistence.read({
          ...
          if(null == user._kmd.authtoken) {
            user._kmd.authtoken = Kinvey.getActiveUser('me')._kmd.authtoken;
          }
      ...
      create: function(data, options) {
        ...
        if(false !== options.state && null !== Kinvey.getActiveUser('create')) {
      ...
      update: function(data, options) {
        ...
        var promise = Kinvey.Persistence.update({
          ...
          var activeUser = Kinvey.getActiveUser('update');
      ...
      destroy: function(id, options) {
        ...
        var promise = Kinvey.Persistence.destroy({
          ...
          var activeUser = Kinvey.getActiveUser('destroy');
    ...
    var MIC = {
      ...
      login: function(authorizationGrant, redirectUri, options) {
        ...
        var activeUser = Kinvey.getActiveUser('login');
        var error;
        var promise;
      ...
      refresh: function(options) {
        var error;
        var clientId = Kinvey.appKey;
        var activeUser = Kinvey.getActiveUser('refresh');
        var redirectUri;
        var promise;
    ...
    Kinvey.Persistence.Local = /** @lends Kinvey.Persistence.Local */ {
      ...
      read: function(request, options) {
        ...
        if('_me' === request.collection) { // Me.
          ...
          var user = Kinvey.getActiveUser('read');
          if(null !== user) {
        ...
        return promise.then(function() {
          ...
          return response.then(null, function(error) {
            if(Kinvey.Error.USER_LOCKED_DOWN === error.name) {
              ...
              var activeUser = Kinvey.getActiveUser('_request');
