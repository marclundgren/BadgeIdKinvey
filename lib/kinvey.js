      ...
      logout: function(options) {
        ...
        if(null === Kinvey.getActiveUser('logout')) {
          ...
          promise = Kinvey.Persistence.create({
            ...
            return MIC.disconnect().then(function(resp){
              console.log('disconnected MIC', resp);
              return resp;
            })
            .catch(function(error){
              console.log('uh oh. could not disconnect MIC', error);
            });
          }).then(function() {
            var error;
    ...
    Kinvey.Persistence.Net = /** @lends Kinvey.Persistence.Net */ {
      ...
      _request: function(request, options) {
        ...
        return promise.then(function() {
          ...
          .catch(function(error) {
            debugger
            console.log('Kinvey.Persistence.Net.request error', error);
          })
          .then(function(response) {
            debugger
            // Parse the response.
